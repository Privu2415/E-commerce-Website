const products = [
{ id:1, name:"DSLR Camera", category:"electronics", price:599.99, originalPrice:699.99, discount:14, rating:4.7, reviews:320, image:"https://s3bg.cashify.in/gpro/uploads/2023/01/11034330/nikon-d3500-digital-slr-front.jpg" },
...
{ id:14, name:"Sneakers", category:"fashion", price:84.99, originalPrice:119.99, discount:29, rating:4.5, reviews:310, image:"https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTn6DTFyKxZlbpg30zmQ5JgjWOaNphkYMI7_6GAAFAGgrSyS9IOLnfkh4Jz2DSs4YQoCIIHe1vIzqNz1nLWs03wqrQWVF0wyVowykusie6u9LMt0diwllc9qFw" },
...
{ id:20, name:"Skipping Rope", category:"sports", price:12.99, originalPrice:17.99, discount:28, rating:4.4, reviews:210, image:"https://images.meesho.com/images/products/224969155/0lci7_512.avif?width=512" }
];
...
const updateCart = () => {
    ...
    if (cart.length === 0) {
        el('cartItems').innerHTML = '<div class="empty-cart"><p>Your cart is empty</p></div>';
    } else {
        el('cartItems').innerHTML = cart.map(i => `
            <div class="cart-item">
                ...
                <button class="cart-remove-btn" onclick="removeFromCart(${i.id})">Remove</button>
            </div>
        `).join('');
    }
